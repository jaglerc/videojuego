...
export default function RegisterPage() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      <img src={fondoBosque} alt="fondoBosque" className="absolute inset-0 w-full h-full object-cover z-0" />
      <div className="absolute inset-0 z-10 flex flex-col items-center px-6 pt-10">
        <div className="w-full max-w-[350px]">
          <div className="flex items-center justify-center gap-1 mb-6">
            <img src={logo} alt="logo" className="w-[350px] h-[150px] object-contain object-right mt-1 -ml-20 -mr-20" />
